...
var contatore = 0;
  ...
  function calcolo()
  {
    ...
    //Costi Acquisto
        ...
        let maxiRataTotale = maxiRata * Math.min(Math.floor(anniSimulazione,durataFinanziamento/12),1) + maxiRata * Math.floor(anniSimulazione/(durataAuto+durataFinanziamento/12));
